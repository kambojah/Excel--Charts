...
public class Table {
    ...
    @XmlElement(name = "Row")
    private List<com.uttesh.pdfngreport.util.xml.Row> row;
    ...
    @XmlTransient
    public List<com.uttesh.pdfngreport.util.xml.Row> getRow() {
        return row;
    }

    public void setRow(List<com.uttesh.pdfngreport.util.xml.Row> row) {
        this.row = row;
    }
